...
const typeColors: Record<Notification['type'], string> = {
  maintenance: 'bg-blue-50 text-blue-700 dark:bg-blue-500/15 dark:text-blue-400',
  warranty: 'bg-amber-50 text-amber-700 dark:bg-yellow-500/15 dark:text-yellow-400',
  work_order: 'bg-purple-50 text-purple-700 dark:bg-purple-500/15 dark:text-purple-400',
  approval: 'bg-emerald-50 text-emerald-700 dark:bg-green-500/15 dark:text-green-400',
  system: 'bg-slate-50 text-slate-600 dark:bg-gray-500/15 dark:text-gray-400',
};
