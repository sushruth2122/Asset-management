...
const stageBadge: Record<string, string> = {
  planning: 'bg-purple-50 text-purple-700 dark:bg-purple-500/15 dark:text-purple-400',
  ...
  inactive: 'bg-slate-50 text-slate-600 dark:bg-slate-500/15 dark:text-slate-400',
  retired: 'bg-red-50 text-red-700 dark:bg-red-500/15 dark:text-red-400',
  disposed: 'bg-gray-50 text-gray-600 dark:bg-gray-500/15 dark:text-gray-400',
};
