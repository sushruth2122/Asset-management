...
const docTypeBadge: Record<string, string> = {
  manual: 'bg-blue-50 text-blue-700 dark:bg-blue-500/15 dark:text-blue-400',
  warranty: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-400',
  certificate: 'bg-purple-50 text-purple-700 dark:bg-purple-500/15 dark:text-purple-400',
  inspection: 'bg-amber-50 text-amber-700 dark:bg-amber-500/15 dark:text-amber-400',
  compliance: 'bg-red-50 text-red-700 dark:bg-red-500/15 dark:text-red-400',
  insurance: 'bg-teal-50 text-teal-700 dark:bg-teal-500/15 dark:text-teal-400',
  general: 'bg-slate-50 text-slate-600 dark:bg-slate-500/15 dark:text-slate-400',
};

const DOC_TYPES: DocumentType[] = ['manual', 'warranty', 'certificate', 'inspection', 'compliance', 'insurance', 'general'];
