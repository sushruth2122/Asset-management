...
const healthConfig: Record<string, { icon: typeof Activity; color: string; bg: string }> = {
  good: { icon: CheckCircle, color: 'text-emerald-700 dark:text-emerald-400', bg: 'bg-emerald-50 dark:bg-emerald-500/15' },
  fair: { icon: Clock, color: 'text-amber-700 dark:text-amber-400', bg: 'bg-amber-50 dark:bg-amber-500/15' },
  poor: { icon: AlertTriangle, color: 'text-red-700 dark:text-red-400', bg: 'bg-red-50 dark:bg-red-500/15' },
  critical: { icon: AlertTriangle, color: 'text-red-700 dark:text-red-500', bg: 'bg-red-100 dark:bg-red-500/25' },
};
