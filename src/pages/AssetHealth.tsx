      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-description">
            Real-time monitoring and IoT sensor data
          </p>
        </div>
            ...
            <CardContent>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline" className="bg-red-50 text-red-700 border-red-200 dark:bg-red-500/15 dark:text-red-400 dark:border-red-500/30">
                    {anomalyAlerts.new}
                  </Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Acknowledged</span>
                  <Badge variant="outline" className="bg-amber-50 text-amber-700 border-amber-200 dark:bg-yellow-500/15 dark:text-yellow-400 dark:border-yellow-500/30">
              ...
              {anomalyAlerts.new === 0 ? (
                ...
                <div className="space-y-2">
                  {anomalyAlerts.assets.map((asset) => (
                    <div 
                      key={asset.id} 
                      className="flex items-center justify-between p-2 rounded bg-red-50/50 border border-red-200 dark:bg-red-500/10 dark:border-red-500/20"
                    >
                      <div className="flex items-center gap-2">
