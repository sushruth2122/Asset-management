  ...
  return (
    <div className="space-y-6">
      ...
      <div className="page-header">
        <div>
          <h1 className="page-title">Asset Master</h1>
          <p className="page-description">Comprehensive view of all company assets</p>
        </div>
      ...
      <div className="relative">
        ...
        <Input
          placeholder="Search assets by name, code, serial number, location..."
          value={searchQuery}
