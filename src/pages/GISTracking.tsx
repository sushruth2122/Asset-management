  ...
  return (
    <div className="space-y-4">
      <div className="page-header">
        <div>
          <h1 className="page-title">GIS Tracking</h1>
          <p className="page-description">Geographic asset tracking and map view</p>
        </div>
      </div>

      <div className="flex rounded-lg border border-border overflow-hidden" style={{ height: 'calc(100vh - 220px)' }}>
        {/* Filters Sidebar */}
        <div className="w-64 border-r border-border bg-card p-4 overflow-y-auto flex-shrink-0 hidden md:block">
